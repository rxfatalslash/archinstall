...
then
    ...
    (echo o; echo n; echo p; echo ""; echo ""; echo +512M; echo n; echo p; echo ""; echo ""; echo "+${raiz}"; echo n; echo p; echo ""; echo ""; echo +4.5G; echo t; echo 3; echo 82; echo a; echo 1; echo w; echo q;) | fdisk ${disco}

    mkfs.vfat -F 32 ${disco}1
    mkfs.ext4 ${disco}2
    mkswap ${disco}3
    swapon
